...
//Survivors
static NoOfAdsSurvivors = 5;
static const String:AdvertTextSurvivor[][]={
	"\x04[KIDDO]\x03 Press and Hold CTRL to use 1337-5P337"
	,"\x04[KIDDO]\x03 Try our Jetpacks, say: /jetpack, they are safe, sort of..."
	,"\x04[KIDDO]\x03 You can help yourself by holding CTRL"
	,"\x04[KIDDO]\x03 Here melee weapons perform better, TRY IT!"
	,"\x04[KIDDO]\x03 Try our !buy Command"
}
static ads_i_survivor = 0;

//Infected Advertisements Below
static NoOfAdsInfected = 5;
static const String:AdvertTextInfected[][]={
	"\x04[KIDDO]\x03 Press and Hold CTRL to use 1337-5P337"
	,"\x04[KIDDO]\x03 Click right mouse button to change zombie-class"
	,"\x04[KIDDO]\x03 Jockeys Jump WAY higher here, give it a try!"
	,"\x04[KIDDO]\x03 Chargers can move around while charging!, also JUMP!"
	,"\x04[KIDDO]\x03 You can !buy a tank and a witch, or anything else!"
	,"\x04[KIDDO]\x03 You can take control over the the Witch!!! press E while standing next to her"
}
